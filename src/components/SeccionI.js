...
const SeccionI = () => {
  return (
        <div className="col-md-12 shadow-lg px-2 mt-2">
            <div className="row">
                    ...
                    <div className="col-md-8 mt-2 py-2">
                        ...
                        <p py-2>Bienvenidos a mi portfolio, soy un desarrolador con habilidades en frontend/backend, sigo adquiriendo conocimiento y mi fuerte es la libreria React.js</p>
                    </div>
